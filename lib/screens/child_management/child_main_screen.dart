      ...
      child: Scaffold(
          ...
          body: context.read<ChildNotifier>().children.length == 0
              ...
              : searchTextEditingController.text.isEmpty
                  ? ListView.separated(
                      itemCount: context.watch<ChildNotifier>().children.length + 1,
                      itemBuilder: (BuildContext context, int index) {
                        return index < context.watch<ChildNotifier>().children.length ? bulidChildListTile(context.watch<ChildNotifier>().children[index]) : buildListTile(titleText: '');
                      },
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return index < searchResult.length ? bulidChildListTile(searchResult[index]) : buildListTile(titleText: '');
                      },
                      separatorBuilder: (BuildContext context, int index) {
                        return const Divider(color: Colors.black);
                      },
