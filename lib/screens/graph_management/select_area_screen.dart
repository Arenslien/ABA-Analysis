...
class SelectAreaScreen extends StatefulWidget {
  ...
  const SelectAreaScreen({Key? key, required this.isDate, required this.child,required this.programField}) : super(key: key);
...
//      subtitleText: "평균성공률: $average%",
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => SelectItemScreen(
          isDate: false,
          child: widget.child,
          subField: subField,
