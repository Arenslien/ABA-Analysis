...
class SubItemInputScreen extends StatefulWidget {
  final SubField subField;
  const SubItemInputScreen({Key? key, required this.subField})
      : super(key: key);

  @override
  _SubItemInputScreenState createState() => _SubItemInputScreenState();
}

class _SubItemInputScreenState extends State<SubItemInputScreen> {
  _SubItemInputScreenState();
  late String title;
